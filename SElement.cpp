...
bool  SElement::operator < (SElement &arg) {
    return this->fu < arg.fu;
}

SElement::SElement(SequenceArg &arg) {
    this->arg = std::shared_ptr<SequenceArg>(new SequenceArg(arg.get_first(),arg.get_second()));
}
